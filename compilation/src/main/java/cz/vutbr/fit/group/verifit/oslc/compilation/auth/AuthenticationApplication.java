...
package cz.vutbr.fit.group.verifit.oslc.compilation.auth;
...
public class AuthenticationApplication implements Application {
    ...
    public final static String APPLICATION_NAME = "VeriFit Compilation";
    public final static String OAUTH_REALM = "VeriFit Compilation";
    protected final static String APPLICATION_CONNECTOR_SESSION_ATTRIBUTE = "cz.vutbr.fit.group.verifit.oslc.compilation.auth.ApplicationConnector";
    protected final static String APPLICATION_CONNECTOR_ADMIN_SESSION_ATTRIBUTE = "cz.vutbr.fit.group.verifit.oslc.compilation.auth.AdminSession";
