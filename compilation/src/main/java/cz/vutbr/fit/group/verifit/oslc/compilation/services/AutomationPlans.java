...
public class AutomationPlans
{
    ...
    private static final Logger log = LoggerFactory.getLogger(AutomationPlans.class);
    ...
    @ApiOperation(
        ...
        notes = "GET for resources of type {'" + "<a href=\"" + Oslc_autoDomainConstants.AUTOMATIONPLAN_TYPE + "\">" + Oslc_autoDomainConstants.AUTOMATIONPLAN_LOCALNAME + "</a>" + "'}" +
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final AutomationPlan aAutomationPlan = VeriFitCompilationManager.getAutomationPlan(httpServletRequest, id);

        if (aAutomationPlan != null) {
            // Start of user code getAutomationPlan
            // End of user code
            httpServletResponse.setHeader("ETag", VeriFitCompilationManager.getETagFromAutomationPlan(aAutomationPlan));
    ...
    public void getAutomationPlanAsHtml(
        @PathParam("id") final String id
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationplan.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationplansmallpreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationplanlargepreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
