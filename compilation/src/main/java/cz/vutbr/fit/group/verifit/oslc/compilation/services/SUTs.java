...
public class SUTs
{
    ...
    private static final Logger log = LoggerFactory.getLogger(SUTs.class);
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final SUT aSUT = VeriFitCompilationManager.getSUT(httpServletRequest, id);

        if (aSUT != null) {
            // Start of user code getSUT
            // End of user code
            httpServletResponse.setHeader("ETag", VeriFitCompilationManager.getETagFromSUT(aSUT));
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSUT != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/sut.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSUT != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/sutsmallpreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aSUT != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/sutlargepreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
