...
public class AutomationPlanDefinition {
	...
	{ 
		try {
			...
			sourceGitUrl.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			//sourceGitUrl.setReadOnly(false);
			sourceGitUrl.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING))); // TODO change to URI
			...
			sourceUrl.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			sourceUrl.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING)));
			...
			sourceBase64.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			sourceBase64.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING)));
			...
			sourceFilePath.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			sourceFilePath.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING)));
			...
			unpackZip.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			unpackZip.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_BOOL)));
			...
			buildCommand.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			buildCommand.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING)));
			...
			launchCommand.setOccurs(new Link(new URI(OslcValues.OSLC_OCCURS_ZEROorONE)));
			launchCommand.addValueType(new Link(new URI(OslcValues.OSLC_VAL_TYPE_STRING)));
