...
public class AutomationResults
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final AutomationResult aAutomationResult = VeriFitCompilationManager.getAutomationResult(httpServletRequest, id);

        if (aAutomationResult != null) {
            // Start of user code getAutomationResult
            // End of user code
            httpServletResponse.setHeader("ETag", VeriFitCompilationManager.getETagFromAutomationResult(aAutomationResult));
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationresult.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationresultsmallpreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationResult != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/compilation/automationresultlargepreview.jsp");
            httpServletResponse.addHeader(VeriFitCompilationConstants.HDR_OSLC_VERSION, VeriFitCompilationConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
