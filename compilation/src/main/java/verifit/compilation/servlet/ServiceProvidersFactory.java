...
package verifit.compilation.servlet;
...
import verifit.compilation.services.ServiceProviderService1;
...
,
            new PrefixDefinition(FitDomainConstants.VERIFIT_NAMSPACE_PREFIX, new URI(FitDomainConstants.VERIFIT_NAMSPACE))
        };
