...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - VeriFit Compilation OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>VeriFit Compilation Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>cz.vutbr.fit.group.verifit.oslc.compilation.VeriFitCompilationManager</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
