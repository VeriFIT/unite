...
<%
  List<SUT> resources = (List<SUT>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QuerySUT</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QuerySUT&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
          Number of elements:&nbsp;
          <%= resources.size()%>
      </div>
    </div>
        <% for (SUT aResource : resources) { %>
