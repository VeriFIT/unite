...
<head>
  ...
  <title><%= aAutomationRequest.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>contributor</dt>
            <dd><%= aAutomationRequest.contributorToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>created</dt>
            <dd><%= aAutomationRequest.createdToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>creator</dt>
            <dd><%= aAutomationRequest.creatorToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>description</dt>
            <dd><%= aAutomationRequest.descriptionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>identifier</dt>
            <dd><%= aAutomationRequest.identifierToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>modified</dt>
            <dd><%= aAutomationRequest.modifiedToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>type</dt>
            <dd><%= aAutomationRequest.typeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>title</dt>
            <dd><%= aAutomationRequest.titleToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>instanceShape</dt>
            <dd><%= aAutomationRequest.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>serviceProvider</dt>
            <dd><%= aAutomationRequest.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>state</dt>
            <dd><%= aAutomationRequest.stateToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>desiredState</dt>
            <dd><%= aAutomationRequest.desiredStateToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>inputParameter</dt>
            <dd><%= aAutomationRequest.inputParameterToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
