...
<%
  List<AutomationResult> resources = (List<AutomationResult>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryCapability3</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryCapability3&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
          Number of elements:&nbsp;
          <%= resources.size()%>
      </div>
    </div>
        <% for (AutomationResult aResource : resources) { %>
