...
<head>
  ...
  <title><%= aSUT.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>title</dt>
            <dd><%= aSUT.titleToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>description</dt>
            <dd><%= aSUT.descriptionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>created</dt>
            <dd><%= aSUT.createdToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>creator</dt>
            <dd><%= aSUT.creatorToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>modified</dt>
            <dd><%= aSUT.modifiedToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>identifier</dt>
