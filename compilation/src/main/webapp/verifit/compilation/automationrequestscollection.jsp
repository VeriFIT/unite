...
<%
  List<AutomationRequest> resources = (List<AutomationRequest>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryAutoRequest</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryAutoRequest&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
          Number of elements:&nbsp;
          <%= resources.size()%>
      </div>
    </div>
        <% for (AutomationRequest aResource : resources) { %>
