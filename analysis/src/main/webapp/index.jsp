...
<div class="container">
    <div class="jumbotron">
        ...
        <p class="lead">This is a homepage of the <em>VeriFit Analysis</em> that was generated using
    ...
    <div class="alert alert-primary" role="alert">
        ...
        <hr>
        <p>This initially generated sample front page can be modified, by changing the file <code>analysis/src/main/webapp/index.jsp</code></p>
        <ul>
