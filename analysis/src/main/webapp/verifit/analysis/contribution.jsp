    ...
    <div class="page-header">
      ...
      <a href="<%= aContribution.getAbout() %>"><%= aContribution.getAbout() %></a>
        ...
        <div>
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">fileURI</dt>
            <dd class="col-sm-9"><%= aContribution.fileURIToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">valueType</dt>
            <dd class="col-sm-9"><%= aContribution.valueTypeToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
