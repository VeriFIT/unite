...
<%
  List<Contribution> resources = (List<Contribution>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability QueryContribution</title>
...
<!-- Fixed navbar -->
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;QueryContribution&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
        ...
        <% for (Contribution aResource : resources) { %>
