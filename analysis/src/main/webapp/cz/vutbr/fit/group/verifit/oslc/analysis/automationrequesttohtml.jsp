...
if (request.getParameter("resourceUri") != null) {
    aResource = new AutomationRequest (new URI(request.getParameter("resourceUri")));
}
else {
    if (request.getAttribute("aAutomationRequest") != null) {
        aResource = (AutomationRequest) request.getAttribute("aAutomationRequest");
    }
}

if (asLocalResource != null && asLocalResource.equalsIgnoreCase("true")) {
    out.write("{a Local AutomationRequest Resource} - update AutomationRequest.toString() to present resource as desired.");
}
else {
    if (aResource == null) {
