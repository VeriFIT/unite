...
<div class="container">
    <div class="page-header">
        <h1>AutomationRequest: <%= aAutomationRequest.toString() %></h1>
        <%
        URI shapeUri = UriBuilder.fromUri(OSLC4JUtils.getServletURI()).path(OslcConstants.PATH_RESOURCE_SHAPES).path(Oslc_autoDomainConstants.AUTOMATIONREQUEST_PATH).build();
        Collection<URI> types = aAutomationRequest.getTypes();   
        %>
        <p class="lead">Resource URI:&nbsp;
        <jsp:include page="/cz/vutbr/fit/group/verifit/oslc/automationrequesttohtml.jsp"></jsp:include>
        </p>
        <p class="lead">Shape:&nbsp;
        ...
        <ul>
        <%for (URI type : aAutomationRequest.getTypes()) {%>
        ...
        <div>
          ...
          <dl class="row">
            ...
            for(Link next : aAutomationRequest.getContributor()) {
                if (next.getValue() == null) {
                    ...
                    %>
                    <li>
                    <jsp:include page="/cz/vutbr/fit/group/verifit/oslc/persontohtml.jsp">
          ...
          <dl class="row">
            ...
            <ul>
            <%
            for(Link next : aAutomationRequest.getInputParameter()) {
                if (next.getValue() == null) {
                    out.write("<li>" + "<em>null</em>" + "</li>");
                }
                else {
                    %>
                    <li>
                    <jsp:include page="/cz/vutbr/fit/group/verifit/oslc/parameterinstancetohtml.jsp">
                        <jsp:param name="resourceUri" value="<%=next.getValue()%>"/> 
                        </jsp:include>
                    </li>
                    <%
          ...
          <dl class="row">
            ...
            if ((aAutomationRequest.getExecutesAutomationPlan() == null) || (aAutomationRequest.getExecutesAutomationPlan().getValue() == null)) {
                ...
                %>
                <jsp:include page="/cz/vutbr/fit/group/verifit/oslc/automationplantohtml.jsp">
          ...
          <dl class="row">
            ...
            if ((aAutomationRequest.getProducedAutomationResult() == null) || (aAutomationRequest.getProducedAutomationResult().getValue() == null)) {
                ...
                %>
                <jsp:include page="/cz/vutbr/fit/group/verifit/oslc/automationresulttohtml.jsp">
