...
public class Contributions
{
    ...
    private static final Logger log = LoggerFactory.getLogger(Contributions.class);
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final Contribution aContribution = VeriFitAnalysisManager.getContribution(httpServletRequest, id);

        if (aContribution != null) {
            // Start of user code getContribution
            // End of user code
            httpServletResponse.setHeader("ETag", VeriFitAnalysisManager.getETagFromContribution(aContribution));
    ...
    {
        // Start of user code getContributionAsHtml_init
        // End of user code

        final Contribution aContribution = VeriFitAnalysisManager.getContribution(httpServletRequest, id);

        if (aContribution != null) {
            httpServletRequest.setAttribute("aContribution", aContribution);
            // Start of user code getContributionAsHtml_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/contribution.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        // Start of user code getContributionCompact_init
        ...
        if (aContribution != null) {
            ...
            compact.setAbout(aContribution.getAbout());
            compact.setTitle(aContribution.toString());
            ...
            smallPreview.setDocument(UriBuilder.fromUri(aContribution.getAbout()).path("smallPreview").build());
            compact.setSmallPreview(smallPreview);

            final Preview largePreview = new Preview();
            largePreview.setHintHeight(largePreviewHintHeight);
            largePreview.setHintWidth(largePreviewHintWidth);
            largePreview.setDocument(UriBuilder.fromUri(aContribution.getAbout()).path("largePreview").build());
    ...
    {
        // Start of user code getContributionAsHtmlSmallPreview_init
        // End of user code
        ...
        if (aContribution != null) {
            httpServletRequest.setAttribute("aContribution", aContribution);
            // Start of user code getContributionAsHtmlSmallPreview_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/contributionsmallpreview.jsp");
            httpServletResponse.addHeader(VeriFitAnalysisConstants.HDR_OSLC_VERSION, VeriFitAnalysisConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
    ...
    {
        // Start of user code getContributionAsHtmlLargePreview_init
        // End of user code
        ...
        if (aContribution != null) {
            httpServletRequest.setAttribute("aContribution", aContribution);
            // Start of user code getContributionAsHtmlLargePreview_setAttributes
            // End of user code

            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/contributionlargepreview.jsp");
            httpServletResponse.addHeader(VeriFitAnalysisConstants.HDR_OSLC_VERSION, VeriFitAnalysisConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
    ...
    {
        // Start of user code updateContribution_init
        // End of user code
        final Contribution originalResource = VeriFitAnalysisManager.getContribution(httpServletRequest, id);

        if (originalResource != null) {
            final String originalETag = VeriFitAnalysisManager.getETagFromContribution(originalResource);

            if ((eTagHeader == null) || (originalETag.equals(eTagHeader))) {
                // Start of user code updateContribution
                // End of user code
                final Contribution updatedResource = VeriFitAnalysisManager.updateContribution(httpServletRequest, aResource, id);
                httpServletResponse.setHeader("ETag", VeriFitAnalysisManager.getETagFromContribution(updatedResource));
