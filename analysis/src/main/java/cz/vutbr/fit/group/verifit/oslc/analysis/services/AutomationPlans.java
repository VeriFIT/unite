...
public class AutomationPlans
{
        ...
        ) throws IOException, ServletException, URISyntaxException
    {
        ...
        final AutomationPlan aAutomationPlan = VeriFitAnalysisManager.getAutomationPlan(httpServletRequest, id);

        if (aAutomationPlan != null) {
            // Start of user code getAutomationPlan
            // End of user code
            httpServletResponse.setHeader("ETag", VeriFitAnalysisManager.getETagFromAutomationPlan(aAutomationPlan));
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplan.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplansmallpreview.jsp");
            httpServletResponse.addHeader(VeriFitAnalysisConstants.HDR_OSLC_VERSION, VeriFitAnalysisConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aAutomationPlan != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplanlargepreview.jsp");
            httpServletResponse.addHeader(VeriFitAnalysisConstants.HDR_OSLC_VERSION, VeriFitAnalysisConstants.OSLC_VERSION_V2);
            addCORSHeaders(httpServletResponse);
            rd.forward(httpServletRequest, httpServletResponse);
            return;
