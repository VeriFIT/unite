...
public class ServiceProviderService1
{
    ...
    {
    	String os = VeriFitAnalysisProperties.CONFIG_OS_STR;
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<AutomationPlan> resources = VeriFitAnalysisManager.queryAutomationPlans(httpServletRequest, where, prefix, page, pageSize);
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplanscollection.jsp");
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<AutomationResult> resources = VeriFitAnalysisManager.queryAutomationResults(httpServletRequest, where, prefix, page, pageSize);
        httpServletRequest.setAttribute("queryUri",
                uriInfo.getAbsolutePath().toString() + "?oslc.paging=true");
        if (resources.size() > pageSize) {
            resources.remove(resources.size() - 1);
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationresultscollection.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
            return;
        }
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<AutomationRequest> resources = VeriFitAnalysisManager.queryAutomationRequests(httpServletRequest, where, prefix, page, pageSize);
        httpServletRequest.setAttribute("queryUri",
                uriInfo.getAbsolutePath().toString() + "?oslc.paging=true");
        if (resources.size() > pageSize) {
            resources.remove(resources.size() - 1);
        ...
        ) throws ServletException, IOException
    {
        ...
        if (terms != null ) {
            ...
            final List<AutomationPlan> resources = VeriFitAnalysisManager.AutomationPlanSelector(httpServletRequest, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplanselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationplanselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
        ...
        ) throws ServletException, IOException
    {
        ...
        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<AutomationResult> resources = VeriFitAnalysisManager.AutomationResultSelector(httpServletRequest, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationresultselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            log.error("A empty search should return an empty list and not NULL!");
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationresultselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
        ...
        ) throws ServletException, IOException
    {
        ...
        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<AutomationRequest> resources = VeriFitAnalysisManager.AutomationRequestSelector(httpServletRequest, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationrequestselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            log.error("A empty search should return an empty list and not NULL!");
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationrequestselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
        ...
        ) throws IOException, ServletException
    {
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/cz/vutbr/fit/group/verifit/oslc/analysis/automationrequestcreator.jsp");
        rd.forward(httpServletRequest, httpServletResponse);
    }
    ...
    public void createAutomationRequestFromDialog(MultivaluedMap<String, String> formParams
        ...
        newResource = VeriFitAnalysisManager.createAutomationRequestFromDialog(httpServletRequest, aResource);
